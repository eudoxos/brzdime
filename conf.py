...
BLOG_EMAIL = "info@lessstress.cz"
BLOG_DESCRIPTION = "Prevence relapsu pomocí všímavosti (mindfulness)."  # (translatable)
...
POSTS = (
    ("posts/*.rst", "event", "post.tmpl"),
    ("posts/*.md", "event", "post.tmpl"),
    ("posts/*.txt", "event", "post.tmpl"),
    ("posts/*.html", "event", "post.tmpl"),
)
PAGES = (
    ("pages/*.rst", "", "page.tmpl"),
    ("pages/*.md", "", "page.tmpl"),
...
DEPLOY_COMMANDS = {
    'default': [
        # "rsync -rav --delete --delete-after output/ joe@my.site:/srv/www/site",
        "echo '*** brzdime.cz is deploy via GitHub Action through GitHub Pages, not directly. Commit your changes instead. ***'; exit 1;"
    ]
}
